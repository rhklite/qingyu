#!/bin/bash
# Downloads a whisper.cpp GGML model into ~/.config/flow/models/.
#
...
echo
echo "Point Flow at it by setting modelPath in ~/.config/flow/config.json:"
